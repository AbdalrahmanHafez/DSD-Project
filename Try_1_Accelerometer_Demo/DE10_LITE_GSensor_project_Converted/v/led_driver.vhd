...
architecture rtl of led_driver_led_driver is 
    ...
    begin 
--        select_data <= vl2vh_ternary_func( iG_INT2='1', iDIG(9  downto 5 ), vl2vh_ternary_func( iDIG(9 ), vl2vh_ternary_func( iDIG(8 ), iDIG(8  downto 4 ), X"10"  ), vl2vh_ternary_func( iDIG(8 ), X"f" , iDIG(8  downto 4 ) )='1' )='1');
        signed_bit <= std_logic(select_data(4));
